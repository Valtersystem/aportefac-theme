...
<body <?php body_class('bg-white text-zinc-900 antialiased'); ?>>
    ...
    <div id="page" class="min-h-screen flex flex-col">
        ...
        <header class="border border-[#ffffff1a]">
                        ...
                        <div>
                            ...
                            <?php else: ?>
                                <div class="flex items-center gap-2">
                                    <a href="<?php echo esc_url(home_url('/')); ?>" class="!no-underline font-medium uppercase text-2xl leading-6">
                                        <?php bloginfo('name'); ?>
                                    </a>
                        ...
                        <nav>
                            ...
                            <?php else: ?>
                                ...
                                wp_nav_menu([
                                    ...
                                    'container_class' => '',
                                    'menu_class'      => 'md:flex md:-mx-4 [&_a]:!no-underline h-8',
                                    'theme_location'  => 'primary',
                                    'li_class'        => 'md:mx-4 color-zinc-600 hover:border-b solid transition-colors p-2',
                                    'fallback_cb'     => false,
                                ]);
                                ?>
                            <?php endif; ?>
